...
export default async function AdminDetailPage({
    ...
    return (
        <section>
            <Link href="/dashboard/administradores" className="flex text-text-muted uppercase text-xs font-bold items-center gap-1 mb-4 hover:text-text-main transition-colors">
                <ArrowLeft size={16} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start max-w-7xl mx-auto p-4 mt-4">
                ...
                <div className="lg:col-span-1 bg-surface border border-border-primary rounded-lg p-6 flex flex-col shadow-sm dark:shadow-none transition-colors">
                    ...
                    <div className="flex flex-col items-center mb-8 pt-4 border-t border-border-primary">
                        ...
                        <h2 className="text-xl font-bold text-text-main">{admin.name} {admin.surname}</h2>
                        <p className="text-sm text-text-muted mt-1">Registrado el: 15 ene, 2026</p>
                    </div>
                    ...
                    <div className="bg-surface border border-border-primary shadow-sm dark:shadow-none rounded-lg p-6 flex justify-between items-center transition-colors">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <h3 className="text-2xl font-bold text-text-main">{admin.rol}</h3>
                            </div>
                        </div>
                    </div>
